...
/** Arched window mark, used as the app logo. */
export function Logo(p: P) {
  return (
    <svg {...base({ ...p, strokeWidth: 1.6 })}>
      <path d="M5 11a7 7 0 0 1 14 0v9H5z" />
      <path d="M12 4v16M5 11h14M8.5 15.5h.01M15.5 15.5h.01" />
    </svg>
  )
}
...
export const Merge = (p: P) => (
  <svg {...base(p)}>
    <path d="M6 3v6a6 6 0 0 0 6 6 6 6 0 0 0 6-6V3M18 21v-6M6 21l6-6" />
  </svg>
)
